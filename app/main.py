...
st.write("""
This app uses a post-trained DenseNet121 machine learning model [(Huang et al., 2016)](https://arxiv.org/abs/1608.06993) to classify segmented brain MRI images into four categories: Glioma, Meningioma, Pituitary tumors, or No Tumor. 
